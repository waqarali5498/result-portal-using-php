    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Welcome To Admin Login</a>
          </li>
          </ul>
        <form class="d-flex">
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="">
              ...
              <form class="mx-1 mx-md-4" action="admin_login_select.php" action="post">
            <div class="form-outline form-white mb-2">
            
                <input type="email" name="admemail" id="admemail" class="form-control form-control-sm" />
                <label class="form-label" for="admemail">Admin Email</label>
              </div>

              <div class="form-outline form-white mb-2">
                <input type="password" name="admpass" id="admpass" class="form-control form-control-sm" />
                <label class="form-label" for="admpass">Admin Password</label>
              </div>
