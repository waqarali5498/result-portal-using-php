    ...
    <div class="container-fluid">
      ...
      <div class="collapse navbar-collapse" id="navbarSupportedContent">
        <ul class="navbar-nav me-auto mb-2 mb-lg-0">
          <li class="nav-item">
            <a class="nav-link active" aria-current="page" href="#">Welcome To Student Login</a>
          </li>
          </ul>
        <form class="d-flex">
        ...
        <div class="card bg-dark text-white" style="border-radius: 1rem;">
          <div class="card-body p-5 text-center">
            ...
            <div class="">
              ...
              <h2 class="fw-bold mb-2 text-uppercase">Check Result</h2>
              <form class="mx-1 mx-md-4" action="select_std_login.php" action="post">
              
              <div class="form-outline form-white mb-4">
                  <input type="text" name="stdname" id="" class="form-control form-control-sm" />
                <label class="form-label" for="">Student Name</label>
              </div>

              <div class="form-outline form-white mb-4">
                <input type="text" name="stdroll" id="" class="form-control form-control-sm" />
                <label class="form-label" for="">Student Roll No</label>
              </div>

              
              <button class="btn btn-outline-light btn-sm px-5" name="submit" type="submit">Login</button>
              <a href="student_register.php" type="button" class="btn btn-outline-light btn-sm px-5">Sign Up</a>
